    ...
    return (
      ...
      <Container style={{
        ...
        <Content>
          ...
          >
            <ImageBackground source={require('../../img/bg2.jpg')} style={{ width: '100%', height: '100%', opacity: 1 }} >
              <StatusBar
                backgroundColor={'#ffd129'}
              ...
              <Content >
                ...
                <Text style={{ color: "#000", fontSize: 20, letterSpacing:14 }}>
                      Director
                </Text>
          ...
          <Form style={{ marginBottom: 30 }}>
            ...
            <Text
              style={{ color: "#000", marginTop: 15, fontSize: 16, textAlign: 'center', letterSpacing: 5 }}
            >Codigo
          </Text>
            <Text
              style={{ color: "#ffd129", marginTop: 15, fontSize: 25, fontWeight: "bold", textAlign: 'center', letterSpacing: 3 }}
            >{this.state.token.substr(0, 3) + ' ' + this.state.token.substr(3, 5)}
            </Text>
          </Form>
