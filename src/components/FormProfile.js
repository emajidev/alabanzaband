...
import { Container, Header, Content, Form, Item, Input ,Icon,Label,Spinner} from 'native-base';
...
export default class FormProfile extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Text style={{color:"rgba(80,227,194,1)",paddingTop:30,fontSize:20,textAlign:'center'}}>Completa tu perfil  
     {next==true ?  <Icon style={{ color: 'rgb(255, 209, 41)',fontSize:20}} name="ios-checkmark-circle-outline" /> : console.log("chake_of")}
